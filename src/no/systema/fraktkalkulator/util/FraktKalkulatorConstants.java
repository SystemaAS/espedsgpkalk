 ...
 * 
 */
package no.systema.fraktkalkulator.util;

/**
 * 
 * All type of system constants for FRAKT-KALKULATOR in general
 * 
 ...
 *
 */
public final class FraktKalkulatorConstants {
	
	
	//session constants
	public static final String ACTIVE_URL_RPG_FRAKT_KALKULATOR = "activeUrlRPG_FraktKalkulator";
	public static final String ACTIVE_URL_RPG_UPDATE_FRAKT_KALKULATOR = "activeUrlRPGUpdate_FraktKalkulator";
	...
	*/
	...
	public static final String DOMAIN_RECORD_TOPIC_FRAKT_KALKULATOR = "recordTopicFraktKalkulator";
